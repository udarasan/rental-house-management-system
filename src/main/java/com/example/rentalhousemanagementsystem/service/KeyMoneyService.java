...
public class KeyMoneyService {
    ...
    public String saveKeyMoneyRecord(KeyMoneyDTO keyMoneyDTO) {
        ...
        if (keyMoneyRepository.existsByTransactionID(keyMoneyDTO.getTransactionID())) {
            ...
            int currentKeyMoneyValue = Integer.parseInt(rentedPropertyRepository.getCurrentKeyMoneyValue(keyMoneyDTO.getRentedPropertyID()));
            ...
            if (currentKeyMoneyValue > deductionValue) {
                ...
                rentedPropertyRepository.updateCurrentKeyMoneyValue(String.valueOf(newKeyMoneyValue), keyMoneyDTO.getRentedPropertyID());
            }else {
